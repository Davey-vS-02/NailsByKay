            ...
            <v-container class="my-12">
                <v-card class="pa-8 rounded-lg" elevation="8">
                    ...
                    <v-card-text class="text-body-1">
                        From routine maintenance to complex mechanical repairs, we ensure that every vehicle leaves our workshop road-ready, safe, and efficient. At NailsByKay Mechanic Service & Repair, we don’t just fix cars — we build lasting relationships with our customers through quality service and care.
                    </v-card-text>
                </v-card>
            </v-container>
        </v-main>
